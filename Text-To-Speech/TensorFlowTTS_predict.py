...
Feature_Generation_Config = AutoConfig.from_pretrained(Tacotron2_Configs_Path_De)
Vocoder_Config = AutoConfig.from_pretrained(MB_MelGAN_Configs_Path_De)
Processor = AutoProcessor.from_pretrained(Processor_Path_De)
Feature_Generation_Weights = Tacotron2_Weights_Path_De
Vocoder_Weights = MB_MelGAN_Weights_Path_De
Feature_Generation_Name = 'Tacotron2'
...
Feature_Generator = TFAutoModel.from_pretrained(config=Feature_Generation_Config, pretrained_path=Feature_Generation_Weights, name=Feature_Generation_Name)
Vocoder = TFAutoModel.from_pretrained(config=Vocoder_Config, pretrained_path=Vocoder_Weights, name=Vocoder_Name)
