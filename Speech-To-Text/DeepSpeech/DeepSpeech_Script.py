...
ds = Model(Model_Path)#args.model)
...
ds.enableExternalScorer(Scorer_Path)#args.scorer)
...
audio, _ = librosa.core.load(Audio_Path) #args.audio)#, sr=desired_sample_rate)
